            ...
            <div className="content">
                ...
                <form onSubmit={handleRegister}>
                    ...
                    <div className="input-group">
                        <input type="" placeholder="Cidade" value={city} onChange={e => setCity(e.target.value)} />
                        <input type="" placeholder="UF" style={{ width: 80 }} value={uf} onChange={e => setUf(e.target.value)} />
                    </div>
